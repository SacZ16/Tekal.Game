    ...
    try {
        ...
        if (viewedAssets.Items.length > 0) {
            ...
            if (assetsLessViews.LastEvaluatedKey) {
                ...
                while (arrayAssets.length < limit) {//cambiar el 160 por la cantidad de videos target
                    ...
                    let arrayChunk = arrayAssets.concat(notSeen(array2, [...PKviewed], limit));//tambien :D sofi rompehue
